...
<section class="book" id="book">
    ...
    <div class="row">
        ...
        <label>Medical Record ID</label> <span><input type="text" name="Medical Record ID" readonly value="${mr.medicalRecordId}" class="box"/></span> 
        <label>Symptom:</label><span><textarea  type="text" name="decsriptionService" readonly required  class="box">${mr.symtoms}</textarea></span>
