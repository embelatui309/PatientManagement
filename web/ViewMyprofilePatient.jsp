...
<section class="book" id="book">
    ...
    <div class="row">
        ...
        <form action="ViewAndUpdateServlet" method="POST">
        ...
        <label>Career:</label><span><input type="text" name="Career" required value="${Career}" class="box"/></span>
        <label>BHYT No:</label><span><input type="text" name="codebhyt" required value="${codebhyt}" class="box"/></span>
        <label>Gender:</label>
        ...
        <label>Password:</label><span><input type="text" name="Password" required value="${Password}" class="box"/></span>
