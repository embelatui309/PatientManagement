...
<section class="book" id="book">
    ...
    <div class="row">
        ...
        <label>CCCD:</label><span><input type="text" name="cccd" required class="box"/></span>
        <label>Career:</label><span><input type="text" name="career" required class="box"/></span>
        <label>BHYT No:</label><span><input type="text" name="bhyt" required class="box"/></span>
        <label>Gender:</label>
...
<!--            <input type="password" placeholder="yourPASSWORD" class="box">-->
